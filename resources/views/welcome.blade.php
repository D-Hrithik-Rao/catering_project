    ...
    <div class="container-fluid items-center py-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center logo-image"><img src="{{asset('frontend/img/image.png')}}" style="height: 70px" alt=""></div>
                    <h1 class="display-1">Gandhi Academy of Technology and Engineering</h1>
                    <h1 class="mb-4">Welcome To Our Catering</h1>
                    <div>
                        <a class="btn btn-primary rounded-pill inline-block py-2 px-5" href="{{ url('/login') }}">Login</a>
                        <a class="btn btn-primary rounded-pill inline-block py-2 px-5" href="{{ url('/register') }}">Register</a>
                    </div>
                </div>
            </div>
        </div>
