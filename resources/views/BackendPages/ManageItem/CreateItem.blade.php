...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Create Item</h3>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="item-create-form" method="POST" enctype="multipart/form-data" action="#">
                                        @csrf
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <!-- Main Category -->
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" class="form-control" id="price" placeholder="Enter item price per plate" />
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <!-- Item Type -->
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#item-create-form").on("submit", function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/api/items/create", // Your Laravel API endpoint
                    data: formData,
                    ...
                    success: function(response) {
                        ...
                        $("#item-create-form")[0].reset(); // Reset form
                        $("#imagePreviewContainer").html(""); // Clear image preview
                    },
                    error: function(xhr) {
                    ...
                    complete: function() {
                        submitButton.prop("disabled", false).text("Create Item");
                    }
                });
            });
        ...
        $(document).ready(function() {
            ...
            $("#categoryDropdown").on("change", function() {
                ...
                $.ajax({
                    url: `${API_URL}/Sub-Category/${categoryId}`, // API to get subcategories
                    type: 'GET',
                    success: function(response) {
