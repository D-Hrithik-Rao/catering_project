...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="page-header">
                        <h3 class="fw-bold mb-3">Create main Category</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Category Master</div>
                                </div>
                                <div class="card-body">
                                    <form id="category-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="category_name" class="form-control"
                                                id="name" placeholder="Enter main category name" />
                                        </div>
                                        <div class="form-group">
                                            <label for="display_position">Display Position</label>
                                            <input type="number" name="position" class="form-control"
                                                id="display_position" value="{{ old('position') }}" placeholder="Enter Display Position" />
                                        </div>
            ...
            <div class="modal fade editModal" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form action="{{ url('/Update-Category') }}" method="POST" id="category-edit-form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control"
                                        id="category_name" value="{{ old('name') }}" placeholder="Enter main category name" />
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            getCategory(table); // Fetch categories
            ...
            $(document).on("click", ".editbtn", function() {
                ...
                $.ajax({
                    url: `${API_URL}/Main-Category/Detail/${id}`,
                    type: 'GET',
                    dataType: 'json',
            ...
            // Position update (Fixing issue of event delegation)
            $(document).on("change", ".update-position", function() {
                let position = $(this).val();
                let id = $(this).data("id");
                $.ajax({
                    url: `${API_URL}/Category/update-position`,
                    type: "POST",
                    data: {
                        id: id,
                        position: position,
            ...
            $(document).on("change", ".select-status", function() {
                ...
                let id = $(this).data("id");
                $.ajax({
                    url: `${API_URL}/Category/update-status`, // API endpoint
                    type: "POST",
                    data: {
                        id: id,
                        status: status,
            ...
            // Category Form Submission (Create Category)
            $('#category-form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: `${API_URL}/Main-Category/Create`,
                    data: formData,
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') // Correct CSRF token method
                    },
                    success: function(response) {
                        swal("Success!", "Category has been added successfully!", {
                            icon: "success",
                            buttons: {
                                confirm: {
                            ...
                            $('#category-form')[0].reset(); // Reset form after submission
        ...
        function getCategory(table) {
            $.ajax({
                url: `${API_URL}/Main-Category/List`,
                type: 'GET',
                dataType: 'json',
                success: function(response) {
                    ...
                    <button class="border border-0 bg-transparent deletebtn" data-category-id="${item.id}">
                        <i class="fas fa-trash-alt text-danger border border-danger p-2 fs-5"></i>
                            ...
                            let row = [
                                counter,
                                item.name,
                                `<input type="number" class="form-control update-position" name="position" 
                        placeholder="" value="${item.position}" data-id="${item.id}" id="dis_posn">`,
                                statusSelect,
