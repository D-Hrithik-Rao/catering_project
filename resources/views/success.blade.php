...
<body class="flex p-6 lg:p-8  min-h-screen flex-col">
    <div class="container-fluid items-center py-6 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center logo-image"><img src="{{asset('frontend/img/logo.png')}}" alt=""></div>
                    <h1 class="display-1">Sai Events</h1>
                    <h1 class="mb-4">Your Order has been placed <span class="text-success">successfully!</span></h1>
                    <p class="mb-4">Welcome to Sai Event! We're honored to be serving you today and hope you enjoy the food.</p>
                    <div>
                        <a class="btn btn-primary rounded-pill inline-block py-2 px-5" href="{{ url('/Home') }}">Return To Home</a>
                        <a class="btn btn-primary rounded-pill inline-block py-2 px-5" href="{{ url('/OrderHistory') }}">Check Order</a>
                    </div>
                </div>
            </div>
        </div>
